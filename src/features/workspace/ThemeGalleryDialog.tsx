...
export function ThemeGalleryDialog({ open, onOpenChange }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="!max-w-[1360px] h-[92vh] flex flex-col gap-0 p-0 overflow-hidden"
        hideCloseButton
      ...
      >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <Button
                ...
                className="h-9 gap-2 rounded-xl border-border/60 px-4 text-xs font-medium"
              >
        ...
        <div className="flex min-h-0 flex-1">
          <aside className="w-44 shrink-0 overflow-y-auto border-r border-border/60 bg-muted/[0.03] px-2.5 py-3">
            {BUCKETS.map((btn) => (
              ...
              >
                <span className={cn("flex-1 truncate", bucket === btn.key && "text-primary")}>
                  {btn.label}
                </span>
                <span
                  className={cn(
        ...
        <Dialog open={saveOpen} onOpenChange={setSaveOpen}>
          <DialogContent
            className="!max-w-md gap-4 p-6 rounded-2xl"
            hideCloseButton
            aria-describedby={undefined}
          >
            <div className="flex items-center gap-3 pb-1">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground">
                  Captures text styles, background, and logo.
                </p>
              </div>
            </div>
            <Input
        ...
        >
          <DialogContent
            className="!max-w-sm gap-4 p-6 rounded-2xl"
            hideCloseButton
            aria-describedby={undefined}
          >
            <div className="flex items-center gap-3 pb-1">
