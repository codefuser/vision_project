  ...
  return (
    <div className="space-y-2.5">
      <Row>
        ...
        <Field label="Outline">
          <Toggle
            label={style.outlineWidth > 0 ? `${style.outlineWidth}px` : "Off"}
