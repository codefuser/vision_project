...
const ALL: SettingDef[] = [
  ...
  },
  {
    ...
    title: "Transition",
    description: "Default transition effect between projected items",
    keywords: [
      "transition",
      "effect",
      "animation",
  ...
  },
  {
    ...
    description: "Duration of transitions between items in milliseconds",
  ...
  },
  {
    key: "fadeDurationMs",
    title: "Fade Duration",
    description: "Duration of crossfade between items in milliseconds",
    keywords: ["fade", "crossfade", "duration", "speed", "transition", "animation"],
    type: "number",
    category: "projection",
    min: 100,
    max: 5000,
  ...
  },
  {
    key: "blackScreen",
    title: "Black Screen",
    description: "Show a black screen between projected items",
    keywords: ["black", "screen", "blank", "between", "gap", "interval"],
    type: "toggle",
    category: "projection",
  },
  {
  ...
  },
  {
    ...
    description: "Visual animation style for the background",
    keywords: [
      "animation",
      "preset",
      "effect",
    ...
    options: [
      ...
      { value: "golden-worship", label: "Golden Worship" },
      { value: "blue-nebula", label: "Blue Nebula" },
      { value: "aurora", label: "Aurora" },
      { value: "floating-dust", label: "Floating Dust" },
      { value: "moving-clouds", label: "Moving Clouds" },
      { value: "wave-mesh", label: "Wave Mesh" },
    ],
  },
  ...
  // ════════════════ Bible ════════════════
  {
    ...
    description: "Primary Bible translation language",
    keywords: ["bible", "translation", "language", "version", "scripture"],
    type: "select",
    category: "bible",
    options: [
  ...
  },
  {
    key: "tamilVersion",
    title: "Tamil Version",
    description: "Tamil Bible version identifier",
    keywords: ["tamil", "bible", "version", "tamil bible", "translation"],
    type: "input",
    category: "bible",
    placeholder: "TCV",
  },
  {
    ...
    description: "English Bible version identifier",
    keywords: ["english", "bible", "version", "kjv", "niv", "esv"],
    type: "input",
    category: "bible",
    placeholder: "KJV",
  },
  {
    key: "tamilFirst",
    title: "Tamil First",
    description: "Show Tamil text as the primary reference",
    keywords: ["tamil", "primary", "language", "order", "priority"],
    type: "toggle",
    category: "bible",
  },
  {
    ...
    description: "Show English and Tamil translations side by side",
    keywords: ["parallel", "dual", "side by side", "bilingual", "both"],
    type: "toggle",
    category: "bible",
  },
  {
    key: "verseNumbering",
    title: "Verse Numbers",
    description: "Show verse numbers in scripture display",
    keywords: ["verse", "number", "reference", "scripture", "chapter"],
    type: "toggle",
    category: "bible",
  },
  {
    ...
    description: "Display the scripture reference on screen",
    keywords: ["reference", "verse", "citation", "display", "show"],
    type: "toggle",
    category: "bible",
  },
  {
    ...
    description: "Position of the scripture reference on screen",
    keywords: ["reference", "position", "top", "bottom", "overlay", "placement"],
    type: "select",
    category: "bible",
    options: [
      { value: "bottom", label: "Bottom" },
  ...
  },
  {
    ...
    description: "Font size of the scripture reference in pixels",
    keywords: ["reference", "size", "font", "verse", "text", "small"],
    type: "slider",
    category: "bible",
    min: 8,
    max: 48,
  ...
  {
    key: "verseSplit",
    title: "Verse Split Mode",
    description: "How multiple verses are displayed",
    keywords: ["verse", "split", "single", "range", "chapter", "display"],
    type: "select",
    category: "bible",
    options: [
      { value: "single", label: "Single Verse" },
      { value: "range", label: "Verse Range" },
      { value: "chapter", label: "Full Chapter" },
    ],
  },
  {
    key: "verseAnimation",
    title: "Verse Animation",
    description: "Animate verse transitions in the display",
    keywords: ["verse", "animation", "transition", "effect", "bible", "motion"],
    type: "toggle",
    category: "bible",
  },
  ...
  // ════════════════ Songs ════════════════
  {
    ...
    title: "Search Mode",
    description: "Default search method for finding songs",
    keywords: ["search", "mode", "title", "lyrics", "song"],
    type: "select",
    category: "songs",
    options: [
      { value: "title", label: "By Title" },
      { value: "lyrics", label: "By Lyrics" },
      { value: "both", label: "Title & Lyrics" },
    ],
  },
  {
    key: "defaultSorting",
    title: "Song Sorting",
    description: "Default sort order for the song library",
    keywords: ["sort", "order", "song", "list", "arrange", "alphabetical"],
    type: "select",
    category: "songs",
    options: [
  ...
  },
  {
    ...
    description: "Automatically load lyrics when a song is selected",
    keywords: ["lyrics", "auto", "load", "prefetch", "song"],
    type: "toggle",
    category: "songs",
  },
  ...
  // ════════════════ Media ════════════════
  {
    ...
    description: "Display duration for still images in seconds",
    keywords: ["image", "duration", "time", "photo", "slide", "seconds"],
    type: "number",
    category: "media",
    min: 1,
    max: 3600,
  ...
  },
  {
    ...
    description: "Automatically start video playback when selected",
    keywords: ["video", "autoplay", "play", "start", "media"],
    type: "toggle",
    category: "media",
  },
  {
    ...
    keywords: ["loop", "repeat", "video", "cycle", "continuous"],
    type: "toggle",
    category: "media",
  },
  {
    key: "imageScaling",
    title: "Image Scaling",
    description: "How images fit the screen",
    keywords: ["image", "scaling", "fit", "fill", "stretch", "tile"],
    type: "select",
    category: "media",
    options: [
  ...
  },
  {
    key: "videoScaling",
    title: "Video Scaling",
    description: "How videos fit the screen",
    keywords: ["video", "scaling", "fit", "fill", "stretch"],
    type: "select",
    category: "media",
    options: [
      { value: "fill", label: "Fill Screen" },
  ...
  // ════════════════ Remote Control ════════════════
  {
    key: "remoteEnabled",
    title: "Enable Remote",
    description: "Allow remote devices to control presentations",
    keywords: ["remote", "control", "enable", "network", "device"],
    type: "toggle",
  ...
  },
  {
    key: "qrCodeEnabled",
    title: "QR Code",
    description: "Show a QR code for quick remote connection",
    keywords: ["qr", "code", "scan", "connect", "remote"],
    type: "toggle",
    category: "remote-control",
  },
  {
    key: "pinCode",
    title: "PIN Code",
    description: "PIN required to connect remotely",
    keywords: ["pin", "code", "security", "remote", "password"],
    type: "input",
    category: "remote-control",
    placeholder: "Not set",
  },
  {
    ...
    keywords: ["reconnect", "auto", "remote", "connection", "retry"],
    type: "toggle",
    category: "remote-control",
  },
