...
const __iconNode$14 = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]];
const ChevronLeft = createLucideIcon("chevron-left", __iconNode$14);
...
const FastForward = createLucideIcon("fast-forward", __iconNode$Y);
const __iconNode$X = [
  [
    "path",
    {
...
const FolderInput = createLucideIcon("folder-input", __iconNode$V);
const __iconNode$U = [
  [
    "path",
    {
...
const ListPlus = createLucideIcon("list-plus", __iconNode$F);
const __iconNode$E = [
...
const ListVideo = createLucideIcon("list-video", __iconNode$E);
...
const MonitorOff = createLucideIcon("monitor-off", __iconNode$A);
const __iconNode$z = [
  [
    "path",
    {
...
const MonitorPlay = createLucideIcon("monitor-play", __iconNode$z);
const __iconNode$y = [
...
const Move = createLucideIcon("move", __iconNode$w);
const __iconNode$v = [
...
const Rewind = createLucideIcon("rewind", __iconNode$k);
const __iconNode$j = [
