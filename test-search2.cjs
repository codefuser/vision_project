if (lt.length >= 4 && qt.length >= 4 && (lt.includes(qt) || qt.includes(lt))) {const fs = require('fs');
...
const targetLine = 'என் தேவா உம்மை நான் ஆராதனை';
...
console.log('Line 2 Norm:', lineNormTokens);
...
console.log('Other song line score:', ls);
