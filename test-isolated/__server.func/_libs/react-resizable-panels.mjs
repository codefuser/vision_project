...
function Xt({
  ...
  }), /* @__PURE__ */ jsxRuntimeExports.jsx(ct.Provider, { value: G, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...S,
      className: t,
...
function Zt({
  ...
  const f = !!r, d = Le(r), h = Re({
    disabled: s
  }), y = reactExports.useRef(null), b = Ce(y, u), {
    getPanelStyles: v,
    id: g,
    orientation: w,
    registerPanel: M,
  ...
  }, P = reactExports.useSyncExternalStore(
    (R) => Pe(g, R),
    x,
    x
  );
  ...
  return P ? I = JSON.parse(P) : i !== void 0 ? I = {
    ...
    flexShrink: void 0,
    flexBasis: i
  } : I = { flexGrow: 1 }, /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...z,
...
function tn({
  ...
  const r = Le(s), l = Re({
    disabled: n,
    disableDoubleClick: o
  }), [c, m] = reactExports.useState({}), [p, S] = reactExports.useState("inactive"), [z, f] = reactExports.useState(false), d = reactExports.useRef(null), h = Ce(d, i), {
    disableCursor: y,
    id: b,
    orientation: v,
    registerSeparator: g,
  ...
  }, [b, r, g, l]), reactExports.useEffect(() => {
